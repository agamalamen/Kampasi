...
@section('app-header')
  <div class="school-header" style="margin-bottom: 10px; margin-top: -30px;">
    <h1 class="text-center" style="color: #fff; padding-top: 30px;font-family: Montserrat;">
  ...
  <div class="row">
    <div class='col-md-8 col-md-offset-2'>
      <select onchange="location = this.value;" data-live-search="true" name="user" class="selectpicker">
        ...
        <option value={{route('get.user.allocated.costs', [Auth::User()->school->username, 'all'])}}>All</option>
        @else
        <option>All</option>
        @endif
